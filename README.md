# VirtualGate-version1
	************************************
*****  	Description de l'application:   	*****
	************************************

Une plateforme qui donne aux différents utilisateurs la possibilité de pouvoir
non seulement y importer leur différents projets 3D mais également (et surtout) de pouvoir 
interagir avec ces derniers de différentes manières (vue aérienne, vue à la première personne etc.).
...
1) 	A l'aide de votre interpretteur de commande (cmd.exe),
	...
	le fichier compressé "VirtualGate.jar"
	('cd [chemin]/[dossier cible]').

2)	Entrer la commande 'java -jar VirtualGate.jar'.
